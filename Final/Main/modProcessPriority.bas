...
Public Function ProcessPriorityGet(Optional ByVal ProcessID As Long, _
...
'    Optional ByVal Priority As ThreadPriority = THREAD_PRIORITY_NORMAL) As ThreadPriority
'
'Dim hThread As Long
'Dim rc As Long
'
